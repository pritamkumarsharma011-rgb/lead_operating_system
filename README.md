...
The repository contains the workflow definitions, dashboard/interface files, and project documentation used to demonstrate the system.

Important project components include:

Lead Qualification Automation
Lead Operating System Demo
Real Estate Dashboard
Buy / Rent / Sell Interfaces
README.md
...
The complete system can be demonstrated through the working lead conversation, qualification workflow, follow-up automation, and dashboard.

The demo shows the complete journey from:
...
- Background workers for higher concurrency
